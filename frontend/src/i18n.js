...
export const UI = {
  es: {
    ...
    secVideoCall: '{Session} (producto de pago)', fPrice: 'Precio', fDuration: 'Duración', fVideoUrl: 'URL del video de presentación', fSlots: 'Horarios disponibles (activa / desactiva)',
  ...
  en: {
    ...
    secVideoCall: '{Session} (paid product)', fPrice: 'Price', fDuration: 'Duration', fVideoUrl: 'Intro video URL', fSlots: 'Available times (toggle on / off)',
